...
- [Pregón](https://fervon.dev/pregon/) - Self-hosted cross-poster and traction tracker for makers: compose once and publish to Bluesky, Mastodon, Reddit, Hashnode and more, with built-in npm/PyPI/GitHub growth tracking. Built with Next.js, Prisma and SQLite.
