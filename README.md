...
- [Ultimate Blog Editor](https://github.com/Masculinn/blog-editor) - An open-source Markdown and Lexical-based blog editor with Supabase sync, MDX rendering, draft/post and media management.
...
- [DevTransform](https://github.com/ensibey/devtransform-hub) - Privacy-first developer utility and document converter suite (145+ tools) with zero server uploads. Built with Next.js 14 SSG, TypeScript, and Tailwind CSS. [Demo](https://devtransform-hub.vercel.app)
