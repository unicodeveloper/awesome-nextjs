...
- [Free Next.js CV Template](https://github.com/cekuu35/free-nextjs-cv-template) - MIT-licensed personal portfolio and CV starter built with Next.js 15, Tailwind CSS, and TypeScript. Multi-page, single-file config, SSG-ready. [Demo](https://20-personal-cv.vercel.app)
