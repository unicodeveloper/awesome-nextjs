...
## Apps
- [AtomicMotion UI](https://github.com/michellesijiama/atomicmotion-ui) - Open-source gallery of copy-paste micro-interactions and animated UI components, each self-contained in one file. Built with Next.js App Router, React, TypeScript, Framer Motion, and Tailwind CSS. [Demo](https://atomicmotion.dev)
