...
- [HookSniff](https://hooksniff.vercel.app) - Open-source webhook delivery platform with a 40+ page Next.js 16 dashboard for real-time monitoring, analytics, endpoint management, and team collaboration. ([Source Code](https://github.com/servetarslan02/HookSniff))
