...
- [Spree Commerce Next.js Storefront](https://github.com/spree/storefront) - Production-ready headless eCommerce storefront with Next.js 16, React 19, TypeScript SDK, cross-border checkout, Stripe/PayPal/Adyen payments (swap easily), and transactional emails. Lighthouse score 98/100 desktop. MIT licensed. [Live Demo](https://demo.spreecommerce.org)
