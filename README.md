...
- [MDX Validate](https://github.com/hwajongpark/mdx-validate) - Pre-deploy checker for Next.js sites that use MDX, catching dead internal links, files that won't compile, and frontmatter that no longer matches your schema.
