...
- [Silkweave](https://github.com/silkweave/silkweave) - TypeScript toolkit for building MCP servers and CLI tools from a single set of actions, with a Next.js App Router adapter (MCP + typed tRPC).
