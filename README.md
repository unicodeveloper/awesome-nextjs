...
- [Element Node](https://github.com/LorenzArtik/element-node) - Open-source (AGPL) self-hosted visual CMS built for AI agents: create and edit whole sites with Claude Code or any MCP client, then refine them in an Elementor-style visual editor. Next.js 15 App Router + Prisma, RSC + ISR caching, no plugin ecosystem needed.
