...
- [auto-geo](https://github.com/shadowresearch/auto-geo) - Publishing engine for AI-search resource pages. Ships Next.js App Router handlers, Zod-validated payloads, and auto-derived Schema.org JSON-LD (Article, FAQPage, BreadcrumbList).
