...
- [Voicefield](https://github.com/tatargabor/voicefield) - Turn a phone into a wireless mic for any text field via QR pairing. Speech runs on phone, server only relays text.
