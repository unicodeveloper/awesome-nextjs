...
- [Pulse](https://github.com/haider484991/pulse-nextjs-dashboard-template) - Free admin dashboard template with Next.js 15, TypeScript and Tailwind CSS v4. SVG charts drawn without a charting library, sortable tables with aria-sort, an auth shell, and a colour-blind-safe palette validated against both light and dark surfaces. Static export, MIT licensed. [Demo](https://pixelandoak-pulse.pages.dev)
- [Table & Fork](https://github.com/haider484991/tablefork-nextjs-restaurant-template) - Free restaurant template with Next.js 15 and Tailwind CSS v4. Real HTML menus rather than PDFs, reservations, a live open/closed badge, and Restaurant + Menu JSON-LD. Zero image files, MIT licensed. [Demo](https://pixelandoak-tablefork.pages.dev)
