...
- [NextAuth v5 Template](https://github.com/nullcryptodev/NextAuth-v5-Template) - A simple template using Google OAuth as a provider for NextAuth v5. Demo: https://next-auth-v5-nullcryptodev.vercel.app/
