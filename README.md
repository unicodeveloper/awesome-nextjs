...
- [GuardLayer](https://www.guardlayer.io) - Free static security scanner for Next.js + Supabase apps; flags exposed keys, missing RLS, and over-permissive policies on every push, with the exact fix. Built with Next.js.
