...
## Apps
- [Peanut Split](https://github.com/peanutprotocol/peanutsplit) - Accountless group expense splitter where the room is a link. 162 currencies, offline PWA, self-hostable (AGPL). [Demo](https://peanutsplit.com)
