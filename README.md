...
- [Nexus Admin Dashboard](https://github.com/Shashank-VK/nexus-dashboard-template) - Responsive dark admin dashboard template with real-time analytics and telemetry.
