...
- [saas-genai-starter](https://github.com/delmalih/saas-genai-starter) - Production-grade multi-tenant GenAI SaaS boilerplate: Next.js 15 + FastAPI, Better Auth (Google/GitHub SSO), bring-your-own-key LLM layer (8 providers), RAG with citations, Stripe billing, evals, and a $0/month deploy. MIT.
