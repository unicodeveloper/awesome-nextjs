...
- [ServerBuddy](https://serverbuddy.net) - Minecraft server discovery platform built with Next.js, featuring live Java and Bedrock status, player history, uptime, MOTD, and version data.
