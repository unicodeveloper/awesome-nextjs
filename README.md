...
* [Log4brains](https://github.com/thomvaill/log4brains) - Architecture Decision Records (ADR) from markdown, with local preview, Hot Reload and SSG, based on Next.js
