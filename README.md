...
- [Apexkit](https://github.com/pnpancholi/apexkit) - A production-grade Next.js boilerplate designed for zero vendor lock-in. Features seamless database integration via Drizzle ORM, baked-in authentication with Better Auth, and modern styling with Tailwind CSS.
