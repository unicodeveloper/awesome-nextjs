...
- [Next.js Blog Starter Template](https://github.com/AKzar1el/blog-starter-template) – 🚀 A modern, production-ready blog template built with Next.js 14, TypeScript, Tailwind CSS, and Turso (SQLite), featuring dynamic Open Graph image generation, RSS feed, sitemap, and built-in analytics.
