...
- [Velobase Harness](https://github.com/velobase/velobase-harness) - Production-grade open-source AI SaaS boilerplate with Next.js 16 and the T3 stack (tRPC, Prisma, Tailwind), featuring Stripe usage-based billing, auth, multi-LLM chat, background workers, lifecycle email, anti-abuse, and an admin dashboard. MIT licensed.
