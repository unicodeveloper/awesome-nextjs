...
- [Thursday](https://github.com/cgoinglove/thursday) - Open-source voice assistant that keeps talking while background bots do the work in a real browser and a shell. A Next.js 16 app you run on your computer with `npx thursday-agent`.
