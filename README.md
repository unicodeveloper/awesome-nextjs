...
* [Next Boilerpack](https://github.com/ixahmedxi/next-boilerpack) - :school_satchel: A typescript based boilerplate with redux, redux-toolkit, theme-ui, react-testing-library, ESLint and many more to make starting new projects quick yet featureful.
