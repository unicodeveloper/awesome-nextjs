...
- [SammaPix](https://www.sammapix.com) - Free browser-based image optimization platform with 20+ tools (compress, WebP convert, AI rename, HEIC convert). Built with Next.js 14, Tailwind CSS, and Zustand. All image processing runs client-side for privacy.
