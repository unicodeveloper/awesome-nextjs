...
- [SaaSLaunch](https://saaslaunch.dev) - Next.js 14 (App Router) SaaS boilerplate with Supabase auth, Stripe/Dodo subscriptions, shadcn/ui, i18n, and SEO defaults pre-wired. $99 one-time, lifetime updates within the major version.
