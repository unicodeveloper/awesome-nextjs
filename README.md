...
- [LynxPrompt](https://github.com/GeiserX/LynxPrompt) - Self-hostable platform for managing AI IDE configuration files across 30+ coding assistants. Built with Next.js, React, Prisma, PostgreSQL, and Tailwind CSS.
