...
- [Voight for Vercel AI SDK](https://github.com/Voightxyz/voight-vercel-ai) - OpenTelemetry SpanExporter for streamText/generateText calls — tokens, tool calls, cost, latency to a hosted dashboard.
