...
- [agents-999](https://github.com/mltech-ai-tw/agents-999) - Open-source library of 999 AI consultant prompt templates you run with your own LLM API key (OpenAI, Anthropic, Gemini, Ollama); no backend, no accounts, keys stay in the browser. Built with Next.js 15.
