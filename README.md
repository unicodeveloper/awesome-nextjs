...
- [Create LINE Bot](https://github.com/MankhongGarden/create-line-bot) - Scaffolds a LINE Messaging API bot on Next.js, Supabase, and Vercel, with a fast webhook ack, idempotent event handling, LIFF login, and a Rich Menu uploader.
