...
- [BistBase](https://github.com/mvtandas/bistbase) - AI-powered stock analysis and backtesting platform for BIST market. Built with Next.js 16, Anthropic Claude SDK, Prisma, PostgreSQL, and Upstash Redis.
