...
## Apps
- [Naratake Free Business Tools](https://naratake.com/en/tools) - 35 free browser-based tools for local businesses: QR and WiFi code generators, LocalBusiness JSON-LD schema, printable hours signs and pricing calculators. Everything runs client-side with no sign-up. Built with Next.js App Router.
