...
- [Next.js TypeScript Starter](https://github.com/jpedroschmitz/typescript-nextjs-starter) - Non-opinionated, highly scalable TypeScript starter for Next.js 16 with React 19, Oxlint, Oxfmt, Husky, Commitlint, T3 Env, CSP, and path mapping.
