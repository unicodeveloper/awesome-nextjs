...
- [Pulse](https://github.com/haider484991/pulse-nextjs-dashboard-template) - Free admin dashboard template with Next.js 15, TypeScript, and Tailwind CSS v4. SVG charts with no charting library, sortable tables, and a colour-blind-safe palette. MIT licensed. [Demo](https://pixelandoak-pulse.pages.dev)
