...
- [Launchkit](https://tgajwani4-a11y.github.io/launchkit-site/) - Next.js, Supabase, and Stripe starter with auth, subscription billing, and webhook sync pre-wired. Paid ($79 one-time).
